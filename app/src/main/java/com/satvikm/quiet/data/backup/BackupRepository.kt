 ...
 * favorites, hidden/renamed apps). Deliberately excludes derived/transient state — the
 * muted-notification digest log, app-open/grace history, and the cached app list itself (which
